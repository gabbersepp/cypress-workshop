    ...
    it("should show correct tickets if filter changed", () => {
        ...
        const tOpen = {
            ...
            data: {
                ...
                column_ticket_Priority: "Reference.ATD.SLAConfigurations.TicketSLAConfigurationOne.TicketPriorities.Standard",
                aggregatedColumn_Sla: {
                    slaRemainingTime: 586083959.1136,
                    slaEndingDate: "2020-11-19T12:24:33Z",
                    slaTranslationKey: "Reference.ATD.SLACriteria.CompleteTime",
                    slaIsOverdue: false
                },
